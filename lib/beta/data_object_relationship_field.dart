...
class DataObjectRelationshipField extends StatelessWidget {
  ...
  const DataObjectRelationshipField({Key? key, required this.data,
    required this.relationshipSpecification }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    filterLabel: relationshipSpecification.filterLabel,
      filterValue: relationshipSpecification.filterLabel,
